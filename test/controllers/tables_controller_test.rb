...
class TablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create table" do
    assert_difference('Table.count') do
      post tables_url, params: { table: { [name: @table.[name, draws: @table.draws, ga: @table.ga, gf: @table.gf, losses: @table.losses, wins: @table.wins } }
    end
  ...
  test "should update table" do
    patch table_url(@table), params: { table: { [name: @table.[name, draws: @table.draws, ga: @table.ga, gf: @table.gf, losses: @table.losses, wins: @table.wins } }
