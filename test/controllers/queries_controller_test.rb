...
class QueriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create query" do
    assert_difference('Query.count') do
      post queries_url, params: { query: { email: @query.email, name: @query.name, query: @query.query } }
    end
  ...
  test "should update query" do
    patch query_url(@query), params: { query: { email: @query.email, name: @query.name, query: @query.query } }
